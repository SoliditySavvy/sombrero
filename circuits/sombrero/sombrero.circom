...
template sombrero( nAppUtxos, levels, nIns, nOuts, feeAsset, indexFeeAsset, indexPublicAsset, nAssets, nInAssets, nOutAssets) {
...
instructionHasher[appUtxoIndex].inputs[0] <== x;
instructionHasher[appUtxoIndex].inputs[1] <== y;
